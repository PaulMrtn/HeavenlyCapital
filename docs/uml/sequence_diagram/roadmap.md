...
| Étape | Séquence/Module | Nom du Diagramme (Statut) | Objectif de la Séquence (Résumé) | Actions Clés |
| :---: | :---: | :--- | :--- | :--- |
| **16** | **Connectivité Critique** | `16-PHASE4-Connectivite-Critique` | Valider la **disponibilité** des services fondamentaux (DB, IBKR, EODHD) et la **pertinence** du contexte de marché (Jour Ouvré, Jours de Rebalancement). | Vérifier **DB** et **IBKR Gateway**. Persister **`MarketDayStatus`**. Si non-ouvré, transition vers `Off-Cycle`. |
